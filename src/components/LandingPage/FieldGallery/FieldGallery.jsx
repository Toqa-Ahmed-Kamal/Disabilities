        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
            {[
              ...
              { title: "الرخصة الدولية للتدريب", detail: "(PCT) | المركز العالمي (CGC) - كندا 2010" },
            ].map((item, idx) => (
              <div 
                key={idx}
                style={{
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "space-between" }}>
            {[
              ...
              "مدرب ومستشار معتمد | مركز الأميرة العنود الدولي للتدريب",
              "مؤسس ومدير عام | حضانة غرس",
            ].map((item, idx) => (
              <div
                key={idx}
                style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom: "15px" }}>
            <p style={{ color: "#b69767", fontSize: "14px", fontWeight: "700", marginBottom: "10px" }}>
              تطوير المنظومة التحليلية للإعاقة بمنطقة المدينة المنورة
            </p>
            <ul style={{ color: theme === "dark" ? "#ddd" : "#444", fontSize: "13px", margin: 0, paddingLeft: "20px" }}>
              <li style={{ marginBottom: "5px" }}>دراسة تنموية مرجعية الأولى من نوعها</li>
              <li>معتمدة من سمو أمير المنطقة كمرجع استراتيجي</li>
            </ul>
          </div>
